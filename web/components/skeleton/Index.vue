<template>
  <div ref="skeleton" class="skeleton p-4 flex flex-col">
    <div
...
<!-- :class="{
  'ml-5': finalLines > 1 && i === 1, // 当行数超过1时，第一行有缩进
  'mr-5': finalLines > 2 && i === finalLines, // 当行数超过2时，最后一行有缩进
}" -->
<script setup>
import { defineProps, onMounted, ref, computed, toRefs } from "vue";
